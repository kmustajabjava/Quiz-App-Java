...
public class DNextQ implements ActionListener
{
    ...
    Color peach=new Color(188,92,88); 
   	Color lightgrey=new Color(220,220,220);
   	Color teal=new Color(0,128,128);
    
    DQuestion eq=new DQuestion();
...
public void result()
{
	peach=new Color(255,203,164);
	frame.setSize(850,730);
	NextLevel=new JButton ("      HOME      ");
